...
//        }
//        [MethodImpl(MethodImplOptions.AggressiveInlining)]
//        private bool Gives_Check<Us, Next>(Move m) where Us : struct, IColor<Us, Next> where Next : struct, IColor<Next, Us>
//        {
//            Bitboard pieces = Get_Pieces();
//            Square from = From_Sq(m);
//            Square to = To_Sq(m);
...
//            {
//                return (Line_BB(from, to) & Get_Pieces<King>(Next.Value)) == 0 || Type_Of(m) == CASTLING;
//            }
//            switch (Type_Of(m))
//            {
//                case NORMAL:
...
//            {
//                case NORMAL:
//                    Do_Move<Us, Next, Normal>(m, ref newSt, Gives_Check<Us, Next>(m), ref scratch_dp, ref scratch_dts);
//                    break;
//                case PROMOTION:
//                    Do_Move<Us, Next, Promotion>(m, ref newSt, Gives_Check<Us, Next>(m), ref scratch_dp, ref scratch_dts);
//                    break;
//                case EN_PASSANT:
//                    Do_Move<Us, Next, EnPassant>(m, ref newSt, Gives_Check<Us, Next>(m), ref scratch_dp, ref scratch_dts);
//                    break;
//                case CASTLING:
//                    Do_Move<Us, Next, Castling>(m, ref newSt, Gives_Check<Us, Next>(m), ref scratch_dp, ref scratch_dts);
//                    break;
//                default:
//                    break;
//            }
